<?php if ( ! defined( 'ABSPATH' ) ) exit;   $vcode = $this->_config["vcode"];  ?>
 ...
 <div id="archivespostaccordion" style="width:<?php echo $this->_config["tp_widget_width"]; ?>"  class="pane_style_2 <?php echo ( ( trim( $this->_config["display_title_over_image"] ) == "yes" ) ? "disp_title_over_img" : "" ); ?>">
